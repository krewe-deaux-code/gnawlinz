export const choiceSeed = [
  { //fight jet
   ...
   { //talk to jet
    flavor_text0: 'You wave your hand to get the attention of the flying object. The object slows and hovers above you, revealing itself as a Lockheed Martin F-35 Lightning II.',
   ...
   { //talk to ZB
    flavor_text0: 'You attempt to make contact with the entity. Is slides grotesquely toward you, gritting its bared teeth. It responds to you only with a low growl and violence.',
    flavor_text1: '',
    story_effect: null,
    enemy_effect: 1,
    ally_effect: null,
